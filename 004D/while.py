...
while j1< meta and j2 <meta:
    ...
    if turno % 2==0:
        ...
        j1+=dado
        print(f"El jugardo 1 obtubo {dado}, avanza hasta la caasilla {j1}")
    else:
        print(f" Turno del jugador 2")
        dado=random.randint(1,6)
        j2+=dado
        print(f"El jugardo 2 obtubo {dado}, avanza hasta la caasilla {j2}")
    turno+=1
if j1>j2:
    print("Haganado el Jugador 1")
else:
    print("Haganado el Jugador 2")
